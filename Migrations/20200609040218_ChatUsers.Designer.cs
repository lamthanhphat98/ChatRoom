...
namespace ChatRoom.Migrations
{
    ...
    [Migration("20200609040218_ChatUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatRoom.Models.Chat.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ChatRoom.Models.ChatUser", b =>
                {
                    b.HasOne("ChatRoom.Models.Chat.Chat", "Chat")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatRoom.Models.User", b =>
                {
                    b.HasOne("ChatRoom.Models.Chat.Chat", null)
                        .WithMany("Users")
                        .HasForeignKey("ChatId");
                });
